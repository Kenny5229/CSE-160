// Cube.js
// Buffered cube with UVs + Normals (36 verts). For Phong lighting.

let g_cubePosBuf = null;
let g_cubeUVBuf  = null;
let g_cubeNorBuf = null;
let g_cubeVertexCount = 36;

function initCubeBuffers(gl, a_Position, a_UV, a_Normal) {
  ...
  // Normals: per-face, duplicated per vertex in that face
  ...
  g_cubeNorBuf = gl.createBuffer();
  gl.bindBuffer(gl.ARRAY_BUFFER, g_cubeNorBuf);
